...
-- Keeps experiments.experiment_data_ver_refs.ref_order as a dense 1-based sequence
...
BEGIN
  ...
  SELECT COALESCE(MAX(ref_order), 0) + 1
    INTO v_next_val
    FROM experiments.experiment_data_ver_refs
  ...
  ELSE
    ...
    UPDATE experiments.experiment_data_ver_refs
...
CREATE TRIGGER tg_ref_order_insert
  BEFORE INSERT ON experiments.experiment_data_ver_refs
